...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_indexing_job_cancel
...
export interface GenaiIndexingJobCancelConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GenaiIndexingJobCancel extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "digitalocean_genai_indexing_job_cancel";
  ...
  * @param importToId The construct id used in the generated config for the GenaiIndexingJobCancel to import
  * @param importFromId The id of the existing GenaiIndexingJobCancel that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_indexing_job_cancel#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "digitalocean_genai_indexing_job_cancel", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_indexing_job_cancel digitalocean_genai_indexing_job_cancel} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GenaiIndexingJobCancelConfig
  */
  public constructor(scope: Construct, id: string, config: GenaiIndexingJobCancelConfig) {
    super(scope, id, {
      terraformResourceType: 'digitalocean_genai_indexing_job_cancel',

...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.39.0/docs/resources/database_postgresql_config
...
export interface DatabasePostgresqlConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly timescaledb?: DatabasePostgresqlConfigTimescaledb[] | cdktf.IResolvable;
}
...
export function databasePostgresqlConfigTimescaledbToTerraform(struct?: DatabasePostgresqlConfigTimescaledb | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    timescaledb: cdktf.numberToTerraform(struct!.timescaledb),
  }
}


export function databasePostgresqlConfigTimescaledbToHclTerraform(struct?: DatabasePostgresqlConfigTimescaledb | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    timescaledb: {
      value: cdktf.numberToHclTerraform(struct!.timescaledb),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class DatabasePostgresqlConfigTimescaledbOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DatabasePostgresqlConfigTimescaledb | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._timescaledb !== undefined) {
      hasAnyValues = true;
      internalValueResult.timescaledb = this._timescaledb;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DatabasePostgresqlConfigTimescaledb | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._timescaledb = undefined;
    }
    else if (cdktf.Tokenization.isResolvable(value)) {
      this.isEmptyObject = false;
      this.resolvableValue = value;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this.resolvableValue = undefined;
      this._timescaledb = value.timescaledb;
    }
  }

  // timescaledb - computed: false, optional: true, required: false
  private _timescaledb?: number; 
  public get timescaledb() {
    return this.getNumberAttribute('timescaledb');
  }
  public set timescaledb(value: number) {
    this._timescaledb = value;
  }
...
export class DatabasePostgresqlConfigTimescaledbList extends cdktf.ComplexList {
  public internalValue? : DatabasePostgresqlConfigTimescaledb[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DatabasePostgresqlConfigTimescaledbOutputReference {
    return new DatabasePostgresqlConfigTimescaledbOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DatabasePostgresqlConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabasePostgresqlConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.39.0/docs/resources/database_postgresql_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.39.0/docs/resources/database_postgresql_config digitalocean_database_postgresql_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // timescaledb - computed: false, optional: true, required: false
  private _timescaledb = new DatabasePostgresqlConfigTimescaledbList(this, "timescaledb", false);
  public get timescaledb() {
    return this._timescaledb;
  }
  public putTimescaledb(value: DatabasePostgresqlConfigTimescaledb[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timescaledb: cdktf.listMapper(databasePostgresqlConfigTimescaledbToTerraform, true)(this._timescaledb.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timescaledb: {
        value: cdktf.listMapperHcl(databasePostgresqlConfigTimescaledbToHclTerraform, true)(this._timescaledb.internalValue),
        isBlock: true,
        type: "list",

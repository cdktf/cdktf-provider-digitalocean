// https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer
...
export interface DataDigitaloceanLoadbalancerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer#id DataDigitaloceanLoadbalancer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer#name DataDigitaloceanLoadbalancer#name}
  */
...
export class DataDigitaloceanLoadbalancerGlbSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // region_priorities - computed: true, optional: false, required: false
  private _regionPriorities = new cdktf.NumberMap(this, "region_priorities");
...
/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer digitalocean_loadbalancer}
*/
export class DataDigitaloceanLoadbalancer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanLoadbalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.43.0/docs/data-sources/loadbalancer digitalocean_loadbalancer} Data Source
  *
  * @param scope The scope in which to define this construct

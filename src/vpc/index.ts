// https://registry.terraform.io/providers/digitalocean/digitalocean/2.30.0/docs/resources/vpc
...
export class Vpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.30.0/docs/resources/vpc#import import section} in the documentation of this resource for the id to use

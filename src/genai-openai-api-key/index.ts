...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.63.0/docs/resources/genai_openai_api_key
...
export class GenaiOpenaiApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenaiOpenaiApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.63.0/docs/resources/genai_openai_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.63.0/docs/resources/genai_openai_api_key digitalocean_genai_openai_api_key} Resource
  *
  * @param scope The scope in which to define this construct

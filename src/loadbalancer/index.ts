...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.50.0/docs/resources/loadbalancer
...
export interface LoadbalancerConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * The network stack determines the allocation of ipv4/ipv6 addresses to the load balancer. Enum: 'IPV4' 'DUALSTACK', (NOTE: this feature is in private preview, contact DigitalOcean support to review its public availability.)
  *
...
export class Loadbalancer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Loadbalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.50.0/docs/resources/loadbalancer#import import section} in the documentation of this resource for the id to use

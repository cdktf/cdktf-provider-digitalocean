...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.42.0/docs/data-sources/sizes
...
export class DataDigitaloceanSizesFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDigitaloceanSizesFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataDigitaloceanSizesFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataDigitaloceanSizesFilterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataDigitaloceanSizesFilterOutputReference {
    return new DataDigitaloceanSizesFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataDigitaloceanSizesSortOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDigitaloceanSizesSort | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataDigitaloceanSizesSort | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataDigitaloceanSizesSortList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataDigitaloceanSizesSortOutputReference {
    return new DataDigitaloceanSizesSortOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataDigitaloceanSizes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanSizes that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.42.0/docs/data-sources/sizes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.42.0/docs/data-sources/sizes digitalocean_sizes} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataDigitaloceanSizesFilterToTerraform, true)(this._filter.internalValue),

// https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets
...
export interface DataDigitaloceanSpacesBucketsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#id DataDigitaloceanSpacesBuckets#id}
  *
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#filter DataDigitaloceanSpacesBuckets#filter}
  */
  readonly filter?: DataDigitaloceanSpacesBucketsFilter[] | cdktf.IResolvable;
  /**
  * sort block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#sort DataDigitaloceanSpacesBuckets#sort}
  */
...
export interface DataDigitaloceanSpacesBucketsFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#all DataDigitaloceanSpacesBuckets#all}
  */
  readonly all?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#key DataDigitaloceanSpacesBuckets#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#match_by DataDigitaloceanSpacesBuckets#match_by}
  */
  readonly matchBy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#values DataDigitaloceanSpacesBuckets#values}
  */
...
export class DataDigitaloceanSpacesBucketsFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDigitaloceanSpacesBucketsFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataDigitaloceanSpacesBucketsFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataDigitaloceanSpacesBucketsFilterList extends cdktf.ComplexList {
  public internalValue? : DataDigitaloceanSpacesBucketsFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataDigitaloceanSpacesBucketsFilterOutputReference {
    return new DataDigitaloceanSpacesBucketsFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataDigitaloceanSpacesBucketsSort {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#direction DataDigitaloceanSpacesBuckets#direction}
  */
...
export class DataDigitaloceanSpacesBucketsSortOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDigitaloceanSpacesBucketsSort | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataDigitaloceanSpacesBucketsSort | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataDigitaloceanSpacesBucketsSortList extends cdktf.ComplexList {
  public internalValue? : DataDigitaloceanSpacesBucketsSort[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataDigitaloceanSpacesBucketsSortOutputReference {
    return new DataDigitaloceanSpacesBucketsSortOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets digitalocean_spaces_buckets}
*/
export class DataDigitaloceanSpacesBuckets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanSpacesBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "digitalocean_spaces_buckets", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.45.0/docs/data-sources/spaces_buckets digitalocean_spaces_buckets} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _filter = new DataDigitaloceanSpacesBucketsFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataDigitaloceanSpacesBucketsFilter[] | cdktf.IResolvable) {
  ...
  private _sort = new DataDigitaloceanSpacesBucketsSortList(this, "sort", false);
  public get sort() {
    return this._sort;
  }
  public putSort(value: DataDigitaloceanSpacesBucketsSort[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataDigitaloceanSpacesBucketsFilterToTerraform, true)(this._filter.internalValue),

...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/data-sources/database_metrics_credentials
...
export interface DataDigitaloceanDatabaseMetricsCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataDigitaloceanDatabaseMetricsCredentials extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "digitalocean_database_metrics_credentials";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "digitalocean_database_metrics_credentials", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/data-sources/database_metrics_credentials digitalocean_database_metrics_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataDigitaloceanDatabaseMetricsCredentialsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataDigitaloceanDatabaseMetricsCredentialsConfig = {}) {
    super(scope, id, {

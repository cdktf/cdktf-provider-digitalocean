  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataDigitaloceanSpacesBucketsFilterToTerraform)(this._filter.internalValue),
      sort: cdktf.listMapper(dataDigitaloceanSpacesBucketsSortToTerraform)(this._sort.internalValue),
    };
  }
}

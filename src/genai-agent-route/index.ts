...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_agent_route
...
export class GenaiAgentRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenaiAgentRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_agent_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.71.0/docs/resources/genai_agent_route digitalocean_genai_agent_route} Resource
  *
  * @param scope The scope in which to define this construct

  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataDigitaloceanImagesFilterToTerraform)(this._filter.internalValue),
      sort: cdktf.listMapper(dataDigitaloceanImagesSortToTerraform)(this._sort.internalValue),
    };
  }
}

...
export class Firewall extends cdktf.TerraformResource {
  ...
  */
  ...
  private _inboundRule?: FirewallInboundRule[] | cdktf.IResolvable; 
  public get inboundRule() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('inbound_rule')));
  }
  public set inboundRule(value: FirewallInboundRule[] | cdktf.IResolvable) {
  ...
  private _outboundRule?: FirewallOutboundRule[] | cdktf.IResolvable; 
  public get outboundRule() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('outbound_rule')));
  }
  public set outboundRule(value: FirewallOutboundRule[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      inbound_rule: cdktf.listMapper(firewallInboundRuleToTerraform)(this._inboundRule),
      outbound_rule: cdktf.listMapper(firewallOutboundRuleToTerraform)(this._outboundRule),
    };
  }
}

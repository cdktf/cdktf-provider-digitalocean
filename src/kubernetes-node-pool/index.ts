...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.63.0/docs/resources/kubernetes_node_pool
...
export class KubernetesNodePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesNodePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.63.0/docs/resources/kubernetes_node_pool#import import section} in the documentation of this resource for the id to use

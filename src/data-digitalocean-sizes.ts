  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataDigitaloceanSizesFilterToTerraform)(this._filter.internalValue),
      sort: cdktf.listMapper(dataDigitaloceanSizesSortToTerraform)(this._sort.internalValue),
    };
  }
}

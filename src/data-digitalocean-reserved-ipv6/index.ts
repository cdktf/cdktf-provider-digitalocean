...
export interface DataDigitaloceanReservedIpv6Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.48.2/docs/data-sources/reserved_ipv6#id DataDigitaloceanReservedIpv6#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.48.2/docs/data-sources/reserved_ipv6#ip DataDigitaloceanReservedIpv6#ip}
  */
  readonly ip: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.48.2/docs/data-sources/reserved_ipv6 digitalocean_reserved_ipv6}
*/
export class DataDigitaloceanReservedIpv6 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDigitaloceanReservedIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.48.2/docs/data-sources/reserved_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.48.2/docs/data-sources/reserved_ipv6 digitalocean_reserved_ipv6} Data Source
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/digitalocean/digitalocean/2.46.0/docs/resources/reserved_ipv6
...
export class ReservedIpv6 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReservedIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.46.0/docs/resources/reserved_ipv6#import import section} in the documentation of this resource for the id to use

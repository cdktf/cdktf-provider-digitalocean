...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.65.0/docs/resources/spaces_bucket_logging
...
export class SpacesBucketLogging extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpacesBucketLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.65.0/docs/resources/spaces_bucket_logging#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.65.0/docs/resources/spaces_bucket_logging digitalocean_spaces_bucket_logging} Resource
  *
  * @param scope The scope in which to define this construct

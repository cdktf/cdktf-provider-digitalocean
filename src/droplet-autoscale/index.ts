...
// https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale
...
export interface DropletAutoscaleConfigA {
  ...
  * Cooldown duration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#cooldown_minutes DropletAutoscale#cooldown_minutes}
  */
  readonly cooldownMinutes?: number;
  /**
  * Max number of members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#max_instances DropletAutoscale#max_instances}
  */
  readonly maxInstances?: number;
  /**
  * Min number of members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#min_instances DropletAutoscale#min_instances}
  */
  readonly minInstances?: number;
  /**
  * CPU target threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#target_cpu_utilization DropletAutoscale#target_cpu_utilization}
  */
  readonly targetCpuUtilization?: number;
  /**
  * Memory target threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#target_memory_utilization DropletAutoscale#target_memory_utilization}
  */
  readonly targetMemoryUtilization?: number;
  /**
  * Target number of members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#target_number_instances DropletAutoscale#target_number_instances}
  */
...
export interface DropletAutoscaleDropletTemplate {
  ...
  * Droplet image
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#image DropletAutoscale#image}
  */
  readonly image: string;
  /**
  * Enable droplet IPv6
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#ipv6 DropletAutoscale#ipv6}
  */
  readonly ipv6?: boolean | cdktf.IResolvable;
  /**
  * Droplet project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#project_id DropletAutoscale#project_id}
  */
  readonly projectId?: string;
  /**
  * Droplet region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#region DropletAutoscale#region}
  */
  readonly region: string;
  /**
  * Droplet size
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#size DropletAutoscale#size}
  */
  readonly size: string;
  /**
  * Droplet SSH keys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#ssh_keys DropletAutoscale#ssh_keys}
  */
  readonly sshKeys: string[];
  /**
  * Droplet tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#tags DropletAutoscale#tags}
  */
  readonly tags?: string[];
  /**
  * Droplet user data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#user_data DropletAutoscale#user_data}
  */
  readonly userData?: string;
  /**
  * Droplet VPC UUID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#vpc_uuid DropletAutoscale#vpc_uuid}
  */
  readonly vpcUuid?: string;
  /**
  * Enable droplet agent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#with_droplet_agent DropletAutoscale#with_droplet_agent}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale digitalocean_droplet_autoscale}
*/
export class DropletAutoscale extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DropletAutoscale that should be imported. Refer to the {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.47.0/docs/resources/droplet_autoscale digitalocean_droplet_autoscale} Resource
  *
  * @param scope The scope in which to define this construct

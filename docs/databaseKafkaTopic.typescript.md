...
```typescript
public readonly uncleanLeaderElectionEnable: boolean | IResolvable;
```
...
```typescript
public resetUncleanLeaderElectionEnable(): void
```
...
| <code><a href="#@cdktf/provider-digitalocean.databaseKafkaTopic.DatabaseKafkaTopicConfigAOutputReference.property.uncleanLeaderElectionEnableInput">uncleanLeaderElectionEnableInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-digitalocean.databaseKafkaTopic.DatabaseKafkaTopicConfigAOutputReference.property.uncleanLeaderElectionEnable">uncleanLeaderElectionEnable</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly uncleanLeaderElectionEnableInput: boolean | IResolvable;
```

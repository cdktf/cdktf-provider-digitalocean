...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v8/kubernetesnodepool"
...
&kubernetesnodepool.KubernetesNodePoolConfig {
	...
	Tags: *[]*string,
	Taint: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v8.kubernetesNodePool.KubernetesNodePoolTimeouts,
}
```

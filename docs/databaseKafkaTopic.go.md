...
```go
func ResetUncleanLeaderElectionEnable()
```
...
| <code><a href="#@cdktf/provider-digitalocean.databaseKafkaTopic.DatabaseKafkaTopicConfigAOutputReference.property.uncleanLeaderElectionEnableInput">UncleanLeaderElectionEnableInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-digitalocean.databaseKafkaTopic.DatabaseKafkaTopicConfigAOutputReference.property.uncleanLeaderElectionEnable">UncleanLeaderElectionEnable</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func UncleanLeaderElectionEnableInput() interface{}
```
...
```go
func UncleanLeaderElectionEnable() interface{}
```

...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v9/customimage"
...
&customimage.CustomImageConfig {
	...
	Id: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v9.customImage.CustomImageTimeouts,
}
```

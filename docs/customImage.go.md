...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/customimage"
...
&customimage.CustomImageConfig {
	...
	Id: *string,
	Tags: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13.customImage.CustomImageTimeouts,
}
```

...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v9/project"
...
&project.ProjectConfig {
	...
	Purpose: *string,
	Resources: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v9.project.ProjectTimeouts,
}
```

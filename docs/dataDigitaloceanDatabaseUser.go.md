...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/datadigitaloceandatabaseuser"
...
```go
func OpensearchAcl() DataDigitaloceanDatabaseUserSettingsOpensearchAclList
```

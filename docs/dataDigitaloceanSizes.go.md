...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v8/datadigitaloceansizes"
...
| <code><a href="#@cdktf/provider-digitalocean.dataDigitaloceanSizes.DataDigitaloceanSizesFilter.property.all">All</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.28.1/docs/data-sources/sizes#all DataDigitaloceanSizes#all}. |

...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/tag"
...
| <code><a href="#@cdktf/provider-digitalocean.tag.Tag.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-digitalocean.tag.TagConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |

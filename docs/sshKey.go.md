...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v12/sshkey"
...
&sshkey.SshKeyConfig {
	...
	PublicKey: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v12.sshKey.SshKeyTimeouts,
}
```

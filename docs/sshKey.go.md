...
```go
import "github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/sshkey"
...
&sshkey.SshKeyConfig {
	...
	PublicKey: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13.sshKey.SshKeyTimeouts,
}
```
